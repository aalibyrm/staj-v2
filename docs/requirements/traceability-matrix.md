...
| ROLE-01 | Student behavior and access | P01/P08 | IN_PROGRESS | P01-W01/W02: Student session, own-data policy, permitted learning/exam routes, and cross-role direct-URL denial verified; shell/data filtering remain later packets. |
| ROLE-02 | Instructor behavior and access | P01/P08 | IN_PROGRESS | P01-W01/W02: Instructor assignment/action policy and guarded teaching/question/grading routes verified; shell/data filtering remain later packets. |
| ROLE-03 | Measurement Specialist behavior and access | P01/P08 | IN_PROGRESS | P01-W01/W02: Measurement assessment/analytics policy and guarded question/exam/analysis routes verified; shell/data filtering remain later packets. |
| ROLE-04 | Program Manager behavior and access | P01/P08 | IN_PROGRESS | P01-W01/W02: Program scope policy and guarded course/outcome/analytics routes verified; shell/data filtering remain later packets. |
| ROLE-05 | Observer behavior and access | P01/P08 | IN_PROGRESS | P01-W01/W02: Observer read-only policy and guarded authorized report/audit routes verified; shell/data filtering remain later packets. |
| ROLE-06 | Platform Administrator behavior and access | P01/P08 | IN_PROGRESS | P01-W01/W02: Platform-only administration policy and guarded dashboard/audit access verified without arbitrary domain mutation; shell remains later. |
...
| TECH-06 | See 02-architecture-and-technical.md TECH-06 | P00-P08 | IN_PROGRESS | P01-W01/W02: route, action, and data-scope decisions are separate deny-by-default policies; canMatch now enforces direct URLs before lazy loading. Row filtering remains P01-W05. |
...
| AC-09 | See 04-acceptance-and-delivery.md AC-09 | P02-P08 | IN_PROGRESS | P01-W01/W02: student, instructor, and program role/scope decisions plus direct-route enforcement verified; filtered datasets remain P01-W05. |
| AC-10 | See 04-acceptance-and-delivery.md AC-10 | P02-P08 | TODO | - |
| AC-11 | See 04-acceptance-and-delivery.md AC-11 | P02-P08 | IN_PROGRESS | P01-W02: public accessible unauthorized state, safe internal return URL, and live denial behavior verified; loading/slow/empty/error/retry patterns remain P01-W04. |
