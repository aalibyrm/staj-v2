...
| TECH-09 | See 02-architecture-and-technical.md TECH-09 | P00-P08 | IN_PROGRESS | P02-W01/W02/W04: normalized keyed state, memoized tracked filters, route/lifecycle-lazy Cytoscape rendering, batched graph replacement, focus controls, and semantic list alternative verified; later large feature lists remain. |
| TECH-10 | See 02-architecture-and-technical.md TECH-10 | P00-P08 | IN_PROGRESS | P00/P01/P02-W01-W04: 110 passing tests cover platform foundations, authorization/scope, learning-domain repository/store/editor behavior, cycle rules, guarded route loading, graph derivation/query/selection/request/edit states, and failed-write preservation; later business rules remain. |
| TECH-11 | See 02-architecture-and-technical.md TECH-11 | P00-P08 | TODO | - |
| TECH-12 | See 02-architecture-and-technical.md TECH-12 | P00-P08 | IN_PROGRESS | P01-W03/W04/P01-REV/P02-W02/W04: shell and outcome screens provide keyboard-native controls, focus/live feedback, ARIA request/save semantics, non-color status/legend cues, and a semantic graph-equivalent table; later feature screens remain. |
| TECH-13 | See 02-architecture-and-technical.md TECH-13 | P00-P08 | IN_PROGRESS | P01-W03/W04/P01-REV/P02-W04: reference-aligned shell and OutcomeGraph passed 1440x900 desktop plus 390x844 narrow gates; narrow defaults to list view with stacked content and no horizontal page overflow. |
...
| TECH-15 | See 02-architecture-and-technical.md TECH-15 | P00-P08 | IN_PROGRESS | P01-W04/P01-REV/P02-W04: URL-source-of-truth state covers shared list filters/history plus OutcomeGraph search/course/level/status/view/selection with canonical default omission and back-navigation cleanup; later report/table adoption remains. |
| CMP-01 | See 02-architecture-and-technical.md CMP-01 | P02-P07 | VERIFIED | P02-W03/W04: OutcomeGraph renders real directed prerequisite relations, mirrors selection in an accessible table/inspector, edits via the facade with expected-version protection, and surfaces actionable repository cycle/conflict failures. |
...
| ADV-04 | See 03-business-rules.md ADV-04 | P02/P04/P05/P07 | VERIFIED | P02-W04: computed filters/focus, stable tracking, batched lifecycle-lazy Cytoscape updates, fit/zoom/selected-node controls, and a semantic list alternative bound graph work and preserve operation for large outcome sets. |
