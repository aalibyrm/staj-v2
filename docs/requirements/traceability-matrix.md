...
| QUESTION-01 | Question types, answers, tags, difficulty, outcome relation | P03 | VERIFIED | P03-W01/W02/W05: immutable entities and guarded server-filtered list/editor workflows cover all six answer shapes and normalized metadata; scoped expected-version bulk tag/status changes now return deterministic per-item success/failure results with confirmation and success-only audit events. |
...
| TECH-03 | See 02-architecture-and-technical.md TECH-03 | P00-P08 | IN_PROGRESS | P03-W02: QuestionEditor uses typed Reactive Forms, dynamic type-specific FormArrays, cross-field course/outcome rules, normalized domain validators, accessible field errors/summary, and first-invalid focus; later feature forms remain. |
...
| TECH-05 | See 02-architecture-and-technical.md TECH-05 | P00-P08 | IN_PROGRESS | P01-W04/P01-REV/P03-W01: reusable search, multi-filter, sort, reset, malformed-input normalization, and history restoration round-trip through URL state; question-bank pagination/filtering/sorting is repository-backed with bounded pages and stale-request cancellation. Later feature lists remain. |
...
| TECH-10 | See 02-architecture-and-technical.md TECH-10 | P00-P08 | IN_PROGRESS | P00/P01/P02/P02-REV/P03-W01-W05: 171 passing tests now cover foundations, authorization/scope, learning repositories/stores/editors, question list/editor/version retention, deterministic bulk partial failures, stale/immutable protection, success-only audit hooks, focus restoration, and filtered selection invariants; later business rules remain. |
...
| TECH-15 | See 02-architecture-and-technical.md TECH-15 | P00-P08 | IN_PROGRESS | P01-W04/P01-REV/P02-W04/W05/P02-REV/P03-W01: URL-source-of-truth state covers shared lists, OutcomeGraph, catalog, and question-bank search/filter/sort/page/selection state; valid deep links survive loading and invalid/default values canonicalize without feedback loops. |
...
| CMP-02 | See 02-architecture-and-technical.md CMP-02 | P02-P07 | VERIFIED | P03-W02: QuestionEditor provides common and six type-specific Reactive Form controls, live preview, exact answer serialization, cross-field/domain validation, accessible errors/focus, draft/review create/update, conflict/service feedback, and published/archived preview-only behavior. |
