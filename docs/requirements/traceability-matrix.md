...
| QUESTION-01 | Question types, answers, tags, difficulty, outcome relation | P03 | VERIFIED | P03-W01: immutable question entities cover all six required types with type-specific answer structures, options, explanations, tags, difficulty, points, course/outcome references, lifecycle/version metadata, and a guarded server-filtered list/inspector. |
...
| TECH-10 | See 02-architecture-and-technical.md TECH-10 | P00-P08 | IN_PROGRESS | P00/P01/P02/P02-REV/P03-W01: 150 passing tests cover foundations, authorization/scope, learning repositories/stores/editors, graph and recommendation rules, fail-closed content access, guarded route loading, question list/query/request/selection behavior, and failed-write preservation; later business rules remain. |
