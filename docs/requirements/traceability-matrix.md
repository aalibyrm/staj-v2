...
| TECH-09 | See 02-architecture-and-technical.md TECH-09 | P00-P08 | IN_PROGRESS | P02-W01/W02/W04/W05: normalized keyed state, memoized tracked filters, lazy graph/catalog routes, batched graph replacement, server-side-like content filter/sort requests, stale cancellation, and bounded 25-row catalog rendering verified; later large feature lists remain. |
| TECH-10 | See 02-architecture-and-technical.md TECH-10 | P00-P08 | IN_PROGRESS | P00/P01/P02-W01-W05: 126 passing tests cover platform foundations, authorization/scope, learning-domain repository/store/editor behavior, cycle rules, graph/catalog request states, content-access enforcement, route loading, and failed-write preservation; later business rules remain. |
| TECH-11 | See 02-architecture-and-technical.md TECH-11 | P00-P08 | TODO | - |
| TECH-12 | See 02-architecture-and-technical.md TECH-12 | P00-P08 | IN_PROGRESS | P01-W03/W04/P01-REV/P02-W02/W04/W05: shell and learning-domain screens provide keyboard-native controls, focus/live feedback, ARIA request semantics, non-color status/access cues, and semantic graph/catalog alternatives; later feature screens remain. |
| TECH-13 | See 02-architecture-and-technical.md TECH-13 | P00-P08 | IN_PROGRESS | P01-W03/W04/P01-REV/P02-W04/W05: reference-aligned shell and learning-domain screens passed 1440x900 desktop plus 390x844 narrow gates with stacked content and no horizontal page overflow. |
...
| TECH-15 | See 02-architecture-and-technical.md TECH-15 | P00-P08 | IN_PROGRESS | P01-W04/P01-REV/P02-W04/W05: URL-source-of-truth state covers shared list filters/history, OutcomeGraph state, and course catalog search/course/level/format/status/sort with canonical defaults, retry preservation, and no route feedback loop; later report/table adoption remains. |
