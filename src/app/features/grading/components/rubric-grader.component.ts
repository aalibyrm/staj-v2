          ...
          <div class="grading-layout">
            ...
            <aside class="context-sidebar" aria-labelledby="context-heading">
              ...
              <section class="total-card" aria-labelledby="total-heading">
                ...
                <span class="eyebrow">Persisted total</span>
                <p>{{ formatPoints(facade.displayedScoreTotal()) }} <small>/ {{ formatPoints(grading.rubric.maximumPoints) }}</small></p>
              </section>
